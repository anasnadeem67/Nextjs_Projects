  ...
  return (
    <div className="py-24 px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 bg-gray-100 text-sm mt-24">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <Link href="/">
        <div className='text-2xl tracking-wide'>EcoMart</div>
        </Link>
        ...
        {/* CENTER */}
        <div className="hidden justify-between lg:flex w-1/2">
        ...
        <div className="flex">
          ...
          <button className="w-1/4 bg-lama text-white hover:bg-opacity-50">JOIN</button>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">Ecomart shop</div>
